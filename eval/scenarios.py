...
SCENARIOS += [
    ...
    # ── 2026-09-09 live chat d8bc5e42: a cancel must be confirmed, «كام» must use the tool ──
    {'id': 'Z74', 'title': 'z: تكرار محجوز ثم «الغاء» → يرد «مش هتتكرر» ولا ينشئ حاجة',
     'turns': [{'text': f'{P1}\n500'}, {'text': f'{P1}\n500', 'gap': 90}, {'text': 'الغاء', 'gap': 60}],
     'expect': {'1': {'tool_texts_contain': ['تحب أكررها'], 'agent_reply': 'silent'},
                '2': {'no_records': True, 'tool_texts_contain': ['مش هتتكرر'],
                      'tools': [{'name': 'qurtoba_confirm_pending_repeats', 'must': False}], 'forbid': SAFE}}},
    {'id': 'Z75', 'title': 'z: «الغاء» ثم «لغيت ؟» → الاتنين بيتردوا، مفيش صمت',
     'turns': [{'text': f'{P1}\n500'}, {'text': f'{P1}\n500', 'gap': 90}, {'text': 'الغاء', 'gap': 60},
               {'text': 'لغيت ؟', 'gap': 60}],
     'expect': {'3': {'no_records': True, 'reply': 'at_least_one', 'forbid': SAFE}}},
    {'id': 'Z76', 'title': 'z: «شوف كدا كام ؟» → أداة الرصيد، مفيش كلام من عندي',
     'turns': [{'text': 'شوف كدا كام ؟'}],
     'expect': {'final': {'tools': [{'name': 'qurtoba_send_customer_balance_to_chat', 'must': True}],
                          'agent_reply': 'silent',
                          'forbid': NARRATION_FORBID + ['رصيدك ثابت', 'مفيش حاجة اتسجلت', 'مفيش أي مبلغ']}}},
    {'id': 'Z77', 'title': 'z: «كام بقى ؟» بعد تحويل → أداة الرصيد برضه',
     'turns': [{'text': f'{P1}\n500'}, {'text': 'كام بقى ؟', 'gap': 60}],
     'expect': {'1': {'tools': [{'name': 'qurtoba_send_customer_balance_to_chat', 'must': True}],
                      'agent_reply': 'silent', 'forbid': NARRATION_FORBID + ['رصيدك ثابت']}}},
]
