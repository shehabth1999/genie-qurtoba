...
@tool(
    ...
    description=(
        ...
        'HOW TO USE: '
        '- Send pretty_ar AS THE WHOLE REPLY in ONE outbound message — do not split, '
        'do not add prologue/epilogue, do not invent extra notes. The grouping, totals, '
        'and timestamps are already in the string. '
