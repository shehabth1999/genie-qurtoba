...
- **A yes to the repeat question** («أيوة», «اه كرر», «كرر الكل», «اعملها») after the system asked «…اتنفذت النهارده بالفعل. تحب أكررها؟» → `qurtoba_confirm_pending_repeats` (no inputs; it creates the held repeats itself and 👍s them) → reply nothing. Never say «هعيد» without calling it. A clear «لا» → nothing to call, reply «تمام».
